...
const handleFilterThesis = async () => {
    ...
    const resFilterThesisByCheckbox = await getAllByFilter(majorFilterList.value, degreeFilterList.value, yearFilterList.value, searchKeyword.value, "student")
