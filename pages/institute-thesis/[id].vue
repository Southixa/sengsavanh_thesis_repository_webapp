<template>
    <div class="w-full min-h-screen bg-gray-100 px-6">
        ...
        <div class="max-w-screen-xl mx-auto pt-6 pb-20">
                    ...
                    <div class="w-full mt-4 grid grid-cols-12">
                        <div class="col-span-4">
                            <div class="w-full h-20 flex items-center">
                                <p class="text-gray-600">ຊື່ຜູ້ຂຽນ:</p>
                            </div>
                        </div>
            ...
            <institute-thesis-recommend-thesis v-if="currentThesis?.thesis_year" :year="currentThesis?.thesis_year" :thesisId="currentThesis?.thesis_id" thesisType="institute"/>
        </div>
    </div>
</template>
...
const breadcrumbItems = [
    ...
    { text: 'ບົດຈົບຂອງສະຖານບັນ', path: '/institute-thesis' },
    { text: 'ລາຍລະອຽດ' }
]
